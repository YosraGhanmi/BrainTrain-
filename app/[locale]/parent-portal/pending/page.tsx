  ...
  return (
    <div className="relative isolate flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#0b1a3a] px-5 py-20">
      ...
      <div className="w-full max-w-lg text-center">
        ...
        <span className="mt-8 block text-sm font-bold uppercase tracking-[0.3em] text-[#ff8c42]">{t('brand')}</span>
        <h1 className="mt-4 font-display text-4xl font-bold text-white sm:text-5xl">{t('title')}</h1>

        <p className="mt-6 text-lg leading-relaxed text-white/70">{t('body1')}</p>
        <p className="mt-3 text-lg leading-relaxed text-white/70">{t('body2')}</p>
