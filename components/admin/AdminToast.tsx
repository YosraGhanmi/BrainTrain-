...
function AdminToastInner() {
  ...
  return (
    <div
      className={`fixed left-4 right-4 top-20 z-50 flex items-center gap-2 rounded-2xl border px-4 py-3 text-sm font-semibold shadow-lg transition-all duration-300 sm:left-auto sm:right-6 sm:top-6 sm:max-w-sm ${
